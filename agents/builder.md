...
- **Test what you build** — add or update tests for new functionality. If the plan doesn't mention tests but the codebase has them, add them anyway. Encode each functional acceptance criterion as an automated test where the project's test setup makes it feasible; report any criterion you left uncovered and why.
